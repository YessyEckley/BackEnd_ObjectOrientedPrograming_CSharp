...
using System;
namespace BackEnd_ObjectOrientedPrograming_CSharp.Week7_StringsArrays.Demo.ArrayDemo
{
    public class ArrayDemo
    {
        ...
        private static void help()
        {
            ...
            Console.WriteLine("\tusearch -- unsorted search");
